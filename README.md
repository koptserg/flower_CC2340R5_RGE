...
#### Светодиодная индикация текущих режимов:
   ...
   3. При отключении устройства от сети красный светодиод мигнет три раза;
   4. При подключении устройства к сети зеленый светодиод мигнет три раза;
   5. При поиске сети зеленый светодиод будет медленно мигать до тех пор, пока устройство не подключится к сети.
### Список литературы:
