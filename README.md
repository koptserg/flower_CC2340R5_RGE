...
#### Автоматический отчет
   1. Отчет значений влажности почвы, батарейки, освещенности, температуры в соответствии с конфигуратором отчетов.
#### Светодиодная индикация текущих режимов:
   1. При кратковременном нажатии кнопки (устройство находится не в сети) красный светодиод мигнет один раз;
   2. При кратковременном нажатии кнопки (устройство находится в сети) зеленый светодиод мигнет один раз;
   3. При выходе устройства из сети красный светодиод мигнет три раза;
   4. При подключении устройства к сети зеленый светодиод мигнет три раза;
   5. При поиске сети (если устройство не прописано в сеть) зеленый светодиод будет медленно мигать до тех пор, пока устройство не подключится к сети.
### Список литературы:
